...
const playerSlot = new mongoose.Schema(
  { user: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, id: String, name: String, email: String, result_screenshot: { type: String, default: "" }, claimed_win: { type: Boolean, default: null } },
  { _id: false }
);
